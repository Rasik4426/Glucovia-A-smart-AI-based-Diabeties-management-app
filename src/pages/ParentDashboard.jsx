...
export default function ParentDashboard() {
  ...
  return (
    <div className="space-y-6">
      <GlucoseAlertSystem userEmail={user?.email} role="parent" />
        ...
        <div>
          ...
          <div className="bg-white rounded-2xl p-8 border border-slate-100 text-center">
            ...
            <div className="flex gap-2 max-w-sm mx-auto">
              <Input value={childEmailInput} onChange={e => setChildEmailInput(e.target.value)} placeholder="child@email.com" className="rounded-xl" />
      ...
      {linkedChildren.length > 0 && (
        <div className="space-y-6">
              ...
              <Dialog open={showLink} onOpenChange={setShowLink}>
                ...
                <DialogContent className="rounded-2xl">
                  ...
                  <div className="space-y-3 mt-2">
                    <Input value={childEmailInput} onChange={e => setChildEmailInput(e.target.value)} placeholder="Child's email" className="rounded-xl" />
          ...
          {/* Glucose Alerts */}
          {unreadAlerts.filter(a => a.message?.includes('ALERT')).length > 0 && (
            <div className="bg-red-50 border-2 border-red-300 rounded-2xl p-4 space-y-2">
              ...
              {unreadAlerts.filter(a => a.message?.includes('ALERT')).map(a => (
            ...
            {showReminderForm && (
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <Input value={reminderMsg} onChange={e => setReminderMsg(e.target.value)} placeholder="Type a message..." className="rounded-xl bg-white flex-1" />
